/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bfaa47d2cca91aa2daa76ebf336ac340)
...
interface __BaseEnv_Env {
	...
	JOB_COORDINATOR: DurableObjectNamespace<import("./src/index").JobCoordinatorDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "JobCoordinatorDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JOB_TIMEOUT_MS" | "MAX_TAXA" | "WORKER_SHARED_SECRET">> {}
}
